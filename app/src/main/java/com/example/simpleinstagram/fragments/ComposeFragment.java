...
public class ComposeFragment extends Fragment {
    ...
    private void savePost(String descripton, ParseUser currentUser, File photoFile) {
        Post post = new Post();
        post.setKeyDescription(descripton);
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null ){
                    ...
                    Toast.makeText(getContext(), "problem in saving that", Toast.LENGTH_SHORT).show();
                }
